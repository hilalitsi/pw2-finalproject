                        ...
                        <div class="p-6.5">
                            <div class="mb-4.5">
                                ...
                                <input
                                    ...
                                    name="fullname"
                                    type="text"
                                    placeholder="Enter type fullname"
                            ...
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black"> Password <span class="text-meta-1">*</span> </label>
                                <input
                                    id="password"
                                    name="password"
                                    type="text"
                            ...
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black"> Email <span class="text-meta-1">*</span> </label>
                                <input
                                    id="email"
                                    name="email"
                                    type="email"
