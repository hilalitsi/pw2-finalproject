            ...
            <div class="flex flex-col">
                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    ...
                    <form action="/users/{{ $user->id }}" method="POST">
                        ...
                        <div class="p-6.5">
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black dark:text-white"> Fullname <span class="text-meta-1">*</span> </label>
                                <input
                                    id="fullname"
                                    name="fullname"
                                    value="{{$user->fullname}}"
                            ...
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black dark:text-white"> Username <span class="text-meta-1">*</span> </label>
                                <input
                                    id="username"
                                    name="username"
                                    value="{{$user->username}}"
                            ...
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black dark:text-white"> Password <span class="text-meta-1">*</span> </label>
                                <input
                                    id="password"
                                    name="password"
                                    value="{{$user->password}}"
