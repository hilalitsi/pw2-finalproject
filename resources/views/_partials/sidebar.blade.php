<aside
            ...
            >
                ...
                <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
                    <a href="/welcome">
                        <img src="frontend/img/logo.png" alt="Logo" style="width: 120px; height: 120px;"/>
                    </a>
                            ...
                            <ul class="mb-6 flex flex-col gap-1.5">
                                ...
                                <li>
                                    <a
                                        ...
                                        href="/welcome"
                                        @click="selected = (selected === 'Welcome' ? '':'Welcome')"
                                        :class="{ 'bg-graydark': (selected === 'Welcome') }"
                                    >
                            ...
                            <ul class="mb-6 flex flex-col gap-1.5">
                                ...
                                <li>
                                    <a
                                        class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark"
                                        href="/cars"
                                        @click="selected = (selected === 'Cars' ? '':'Cars')"
                                        :class="{ 'bg-graydark': (selected === 'Cars') }"
                                    >
                                        <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li>
                                    <a
                                        class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark"
                                        href="/loans"
                                        @click="selected = (selected === 'Loans' ? '':'Loans')"
                                        :class="{ 'bg-graydark': (selected === 'Loans') }"
                                    >
                                        <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_130_9756)">
                                                <path
                                ...
                                <li>
                                    <a
                                        class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark"
                                        href="/types"
                                        @click="selected = (selected === 'Types' ? '':'Types')"
                                        :class="{ 'bg-graydark': (selected === 'Types') }"
                                    >
                                        <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_130_9756)">
                                                <path
                                ...
                                <li>
                                    <a
                                        ...
                                        :class="{ 'bg-graydark': (selected === 'Users') }"
                                    >
                                        <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_130_9756)">
                                                <path
