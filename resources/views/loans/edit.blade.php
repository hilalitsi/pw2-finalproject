            ...
            <div class="flex flex-col">
                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    ...
                    <form action="/loans/{{ $loan->id }}" method="POST">
                        ...
                        <div class="p-6.5">
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black dark:text-white"> Car Name <span class="text-meta-1">*</span> </label>
                                <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent dark:bg-form-input">
                                    ...
                                    >
                                        ...
                                        @foreach ($cars as $car)
                                            <option value="{{ $car->id }}" {{ $car->id == $loan->car_id ? 'selected' : '' }}>{{ $car->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black dark:text-white"> User Name <span class="text-meta-1">*</span> </label>
                                <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent dark:bg-form-input">
                                    <select
                                        id="user_id"
                                        name="user_id"
                                    ...
                                    >
                                        ...
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}" {{ $user->id == $loan->user_id ? 'selected' : '' }}>{{ $user->username }}</option>
                                        @endforeach
                                    </select>
                                    <span class="absolute right-4 top-1/2 z-30 -translate-y-1/2">
                                        <svg class="fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="mb-4.5">
                                ...
                                <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent dark:bg-form-input">
                                    ...
                                    >
                                        ...
                                        <option value="Available" {{ $loan->status == 'Available' ? 'selected' : '' }}>Available</option>
                                        <option value="Unavailable" {{ $loan->status == 'Unavailable' ? 'selected' : '' }}>Unavailable</option>
                                    </select>
                                    <span class="absolute right-4 top-1/2 z-30 -translate-y-1/2">
                                        <svg class="fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g opacity="0.8">
