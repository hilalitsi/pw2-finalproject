                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    ...
                    <form enctype="multipart/form-data" action="/cars" method="POST">
                        ...
                        <div class="p-6.5">
                            ...
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black dark:text-white"> Type Car <span class="text-meta-1">*</span> </label>
                            ...
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black dark:text-white"> Year <span class="text-meta-1">*</span> </label>
                                <input
                                    id="year"
                                    name="year"
                                    type="number"
                            ...
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black dark:text-white"> License <span class="text-meta-1">*</span> </label>
                                <input
                                    id="license_plate"
                                    name="license_plate"
                                    type="text"
                                    placeholder="Enter License car"
                                    class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                />
                            </div>
